    ...
    allWork: [
        ...
        },
        {
            ...
            selectedImagesBy2: [
                ...
                {
                    url: '/_gallery/sitel/sitel-gallery-05.png'
                }
            ],
            selectedImages: [{
                url: '/_gallery/sitel/sitel-gallery-01.png'
              },
              {
                url: '/_gallery/sitel/sitel-gallery-02.png'
              },
              {
                url: '/_gallery/sitel/sitel-gallery-03.png'
              },
            ],
        ...
        },
        {
            ...
            fullDescription: `
                <p>
                    A luxury condominium complex in the final stages of construction in downtown Palo Alto, hired us to perform a cleaning of their pre-cast panels and to apply an anti-graffiti sealant to the lower areas of the building.
                </p>
                <p>
                    This project required a timely set up to make sure everything around the panels were safely protected while we apply the necessary product.
                </p>
                <p>
                    We then pressure washed the panels to relieve any dust and dirt before we apply our sealer. After our final application of sealer, we cleaned all surrounding areas and let dry. The two coats of sealer used, dried transparent and remain invisible to the eye.
                </p>
                <p>
                    We were very satisfied with the outcome, and glad to help protect and seal this beautiful building in the heart of downtown Palo Alto.
                </p>
            `,
        ...
        },
        {
            ...
            fullDescription: `
                <p>
                    The Harley Davidson building in Stafford, TX, required maintenance and coatings for their ACM panels.
                </p>
            `,
        ...
        },
        {
            ...
            fullDescription: `
                <p>
                    A building at the UCSF campus required specialized anti-graffiti coating.
                </p>
            `,
        ...
        },
        {
            ...
            fullDescription: `
                <p>
                    We provided glass restoration services for True Wind Capital in San Francisco, CA.
                </p>
            `,
        ...
        },
        {
            ...
            fullDescription: `
                <p>
                    We designed and installed bird netting on this entire 17-story building.    
                </p>
            `,
        ...
        },
        {
            ...
            fullDescription: `
                <p>
                    We designed and installed 3/4″ bird netting for a community built for senior citizens. Our efforts eliminated the birds roosting, preventing a toxic and hazardous environment.
                </p>
            `,
        ...
        },
        {
            ...
            fullDescription: `
                <p>
                    We designed and installed bird netting systems in 7 aircraft hangars, totaling over 650,000 square feet.
                </p>
            `,
        ...
        },
        {
            ...
            fullDescription: `
                <p>
                    We chemically cleaned and blended exterior panels, creating a uniform look. We also resealed the building, and designed and installed a bird control system for this particular project.
                </p>
            `,
        ...
        },
        {
            ...
            fullDescription: `
                <p>
                    We removed scratches from over 5,000 damaged windows on this building covering an entire city block, in downtown Las Vegas.
                </p>
            `,
